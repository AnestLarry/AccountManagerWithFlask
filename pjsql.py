...
class manage_sql:
    ...
    def Search_Item(self,key,keywordStr):
        ...
        for Item in c.fetchall():
            result_Str+='<table border="1"><tr><td>Address</td><td><input readonly style="width:250px" onfocus="this.select()" value="'+base64.b64decode(Item[0].encode()).decode()+'"/></td></tr> \
            <tr><td>  Account  </td><td><input readonly style="width:250px" onfocus="this.select()" value="'+base64.b64decode(Item[1].encode()).decode()+'"/></td></tr> \
            <tr><td>  Password  </td><td><input readonly style="width:250px" onfocus="this.select()" value="'+base64.b64decode(Item[2].encode()).decode()+'"/></td></tr>\
            <tr><td>  Date  </td><td><input readonly style="width:250px" onfocus="this.select()" value="'+base64.b64decode(Item[3].encode()).decode()+'"/></td></tr>\
            <tr><td>  Text  </td><td><input readonly style="width:250px" onfocus="this.select()" value="'+base64.b64decode(Item[4].encode()).decode() +'"/></td></tr></table><br>'
        result_Str+='</font>'
        del c,conn
        return result_Str
